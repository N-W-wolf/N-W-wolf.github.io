...
现在的大模型已经能很好地理解自然语言，Coding Agent 也能自己阅读项目、搜索代码和执行命令，所以日常使用并不需要一套复杂的方法论。多数时候，只要把任务说清楚，让 AI 获得足够的信息，并在最后检查实际结果，就已经能够完成相当多的工作。
...
实际使用时，可以重点考虑三件事：**要做什么、当前是什么情况、有什么重要限制。** 并不是每个问题都要完整写出这三项。简单问题一句话就能解决，复杂任务再逐步补充信息。遇到自己也说不清的问题，也可以先描述现象，然后让 AI 反过来询问：
